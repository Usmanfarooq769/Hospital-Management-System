            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-12 col-xl-12">
                ...
                <div>
                  ...
                  >
                    <div
                      class="appointment-item d-flex align-items-center mb-0 pb-0"
                    >
                      <div
                        :class="[
                          'status-dot',
                          `bg-${appointment.status}`,
                          'me-2',
                        ]"
                      ></div>
                      <div>
                  ...
                  <div
                    class="lines mb-4"
                    v-if="patientData.appointments.length > 0"
                  ></div>
                </div>

                <div
                  class="card shadow-sm"
                  style="border: 1px solid #00a0da; background: transparent"
                >
                  <div class="card-body text-center">
                    <p class="fw-bold text-color">Care Team</p>
                    <p class="mb-0 pb-0 fs-6">Dr Sara Thompson</p>
                    <small class="pt-0 mt-0 text-color"
                      >Primary Physician
                    </small>
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button
                  class="nav-link active tab fs-5 fw-medium"
                  id="working-progress-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#working-progress"
                  type="button"
                  role="tab"
                  aria-controls="working-progress"
                  aria-selected="true"
                >
                  Care Summary
                </button>
              ...
              <li class="nav-item" role="presentation">
                <button
                  class="nav-link tab fs-5 fw-medium"
                  id="generate-report-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#generate-report"
                  type="button"
                  role="tab"
              ...
              <li class="nav-item" role="presentation">
                <button
                  class="nav-link tab fs-5 fw-medium"
                  id="discharge-plan-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#discharge-plan"
                  type="button"
                  role="tab"
                  aria-controls="discharge-plan"
                  aria-selected="false"
                >
            ...
            <div class="row mt-2">
              <div class="col-md-12 col-xl-8">
                ...
                <div class="tab-content mt-4" id="myTabContent">
                  ...
                  >
                    <div class="card p-2 h-100" style="background: #f8f8f8">
                      <div class="crad-body">
      ...
      patients: [
        {
          ...
          workingSummary:
            "7yo male with Type 1 Diabetes. HbA1c 7.2% (improved from 7.8%). Blood glucose readings 80-150 mg/dL. Good compliance with insulin regimen. Continue current management plan.",
          gender: "Male",
          mrn: "45678",
          ...
          physician_alerts: [
            {
              ...
              details: {
                description:
                  "Using accessory muscles, peak flow dropped to 40%",
          ...
          dischargePlan: {
            ...
            followUp: [
              "Cardiology: 12/10/2024 @ 10:00 AM",
              "Diabetes: 12/17/2024",
            ],
            medication: [
              "Morning: BP meds",
          ...
          communicationPlan: {
            ...
            medicationSchedule: [
              "Morning: BP meds, metformin, aspirin",
              "Evening: statin",
            ],
            communicationMethod: {
              Primary: "SMS",
        ...
        },
        {
          ...
          workingSummary:
            "28yo female with ruptured ectopic pregnancy. Unstable VS: BP 90/60, HR 120. Surgical intervention required. 1L hemoperitoneum identified.",
          age: 28,
          gender: "femal",
          mrn: "12345",
          physician_alerts: [
          ...
          summary: [
            {
              ...
              description:
                "28yo female with ruptured ectopic pregnancy. Hemodynamically unstable, BP 90/60. 1L hemoperitoneum on POCUS. Type and cross sent. Proceeding to emergency surgery.",
            },
            {
              id: "2",
              title: "Summary #2",
              ...
              description:
                "Post-op: Successful right salpingectomy. Stable vitals, Hgb 8.5. Received 1 unit PRBC. Pain controlled. Early ambulation initiated.",
            },
          ],
          ...
          dischargePlan: {
            ...
            lifestyleModification: [
              ...
              "early OB consultation next pregnancy",
            ],
          },
          communicationPlan: {
            appointmentReminders: [
            ...
            specialInstructions: [
              ...
              "emotional support hotline provided",
            ],
          },
        ...
        },
        {
          ...
          workingSummary:
            "26yo male presents with acute chest pain. Initial ECG shows ST elevation in V2-V4. Troponin elevated at 2.3 ng/mL. Started on antiplatelet therapy. Cardiac cath lab activated.",
          age: 26,
          gender: "male",
          mrn: "45678",
          ...
          physician_alerts: [
            {
              ...
              details: {
                description:
                  "Patient reported 6/10 chest pain at 14:00. Nitro given with partial relief.",
                action_required:
                  "Pain assessment needed. Consider medication adjustment.",
          ...
          summary: [
            ...
            },
            {
              ...
              description:
                "Post-cardiac catheterization: LAD stent placed. Hemodynamically stable. BP 130/80, HR 75. Started on dual antiplatelet therapy and beta-blocker. Plan for cardiac rehab.",
            },
          ],
          appointments: [
            {
          ...
          medicalReport: {
            ...
            treatmentPlan: {
              ...
              medications: [
                "Albuterol/Ipratropium nebulizersIV ",
          ...
          dischargePlan: {
            dischargeInstructions: [
              ...
              "track peak flow readings 2x daily",
              "avoid known triggers",
            ],
            followUp: [
              "Pulmonologist: 12/06/2024",
              "Asthma education: 12/09/2024",
            ],
            medication: [
          ...
          communicationPlan: {
            ...
            medicationSchedule: [
              "Morning: Fluticasone/Salmeterol inhaler",
              "Evening: Montelukast",
              "Albuterol PRN",
            ],
            communicationMethod: {
            ...
            specialInstructions: [
              ...
              "asthma trigger diary",
              "school nurse notification",
              "action plan review with parents",
            ],
          },
        ...
        },
        {
          ...
          workingSummary:
            "22yo female with acute appendicitis. RLQ pain, fever 100.9°F. Positive surgical signs. Confirmed on imaging. Scheduled for laparoscopic appendectomy.",
          age: 22,
          gender: "female",
          mrn: "54678",
          ...
          summary: [
            {
              ...
              description:
                "22yo female with acute appendicitis confirmed on CT. WBC 14.5K, fever 100.9°F. Started on antibiotics. NPO for surgery.",
            },
            {
              id: "2",
              title: "Summary #2",
              ...
              doctor: "Dr. David Kim",
              description:
                "Successful laparoscopic appendectomy. Minimal blood loss. Tolerating clear liquids. Pain well controlled with oral medications.",
            },
          ],
          ...
          medicalReport: {
            ...
            treatmentPlan: {
              ...
              medications: [
                "IV fluids: Lactated Ringer'sAntibiotics: Ceftriaxone + MetronidazolePain management: Morphine PRN",
              ],
            },
          },
          ...
          communicationPlan: {
            ...
            medicationSchedule: [
              ...
              "Pain meds: alternate ibuprofen/acetaminophen",
            ],
            communicationMethod: {
            ...
            specialInstructions: [
              "Temperature monitoring, wound care schedule",
        ...
        },
        {
          ...
          workingSummary:
            "29yo male with right ear otomycosis following swimming. Failed antibiotic treatment. Presenting with itching, hearing loss, and characteristic fungal plug on examination.",
          age: 29,
          gender: "male",
          mrn: "67890",
          ...
          summary: [
            {
              ...
              description:
                "29yo male presents with right ear otomycosis following swimming. Failed prior antibiotic treatment. Pale grayish fungal plug visible. Hearing decreased on right.",
            },
            {
              id: "2",
              title: "Summary #2",
              ...
              description:
                "Fungal debris removed. Started on topical antifungal drops. Water precautions discussed. Follow-up scheduled for 1 week.",
            },
          ],
          ...
          communicationPlan: {
            ...
            medicationSchedule: [
              "Antifungal drops 3x daily",
              "Treatment calendar provided",
            ],
            communicationMethod: {
              Primary: "Primary",
              Secondary: "SMS",
        ...
        },
        {
          ...
          workingSummary:
            "70yo female with sudden right eye vision loss, temporal headache, scalp tenderness. Giant cell arteritis suspected. Urgent steroid intervention required.",
          age: 70,
          gender: "female",
          mrn: "45324",
          physician_alerts: [
          ...
          summary: [
            {
              ...
              doctor: "Dr. James Wilson",
              description:
                "70yo female with sudden right eye vision loss, temporal headache. Vision CF only in right eye, RAPD present. ESR and CRP markedly elevated. Giant cell arteritis suspected.",
            },
            {
              id: "2",
              title: "Summary #2",
              ...
              description:
                "Started on high-dose IV steroids. Temporal artery biopsy scheduled. Rheumatology consulted. Vision unchanged but headache improved.",
            },
          ],
          ...
          dischargePlan: {
            dischargeInstructions: [
              "Monitor vision changes; Report new symptoms",
        ...
        },
        {
          ...
          workingSummary:
            "10yo child with chronic right ear discharge, new onset fever and mastoid tenderness. CSOM with mastoiditis requiring urgent intervention.",
          age: 10,
          gender: "male",
          mrn: "98765",
          ...
          summary: [
            {
              ...
              description:
                "10yo with chronic right ear discharge, new fever and mastoid tenderness. CSOM with mastoiditis diagnosed. CT shows mastoid opacity. Started on IV antibiotics.",
            },
            {
              id: "2",
              title: "Summary #2",
              ...
              description:
                "Mastoidectomy scheduled for tomorrow. Cultures sent. Afebrile on antibiotics. Ear toileting performed. Parents educated about post-op care.",
            },
          ],
          ...
          medicalReport: {
            ...
            examinationFindings: {
              description:
                "Mucopurulent discharge; Mastoid tenderness; Intact retroauricular sulcus",
            },
          ...
          medications: ["IV antibiotics", "Ear drops", "Pain medication PRN"],
          allergies: [
            {
              substance: "No known drug allergies",
            },
        ...
        },
        {
          ...
          workingSummary:
            "65yo female with postmenopausal bleeding, T2DM, HTN, BMI 36.6. High-risk for endometrial cancer requiring urgent workup.",
          age: 65,
          gender: "female",
          mrn: "78643",
          physician_alerts: [
          ...
          summary: [
            {
              ...
              description:
                "65yo female with postmenopausal bleeding. T2DM, HTN, BMI 36.6. Endometrial thickness 12mm on ultrasound. Endometrial biopsy performed.",
            },
            {
              id: "2",
              title: "Summary #2",
              ...
              doctor: "Dr. Sarah Thompson",
              description:
                "Biopsy sent to pathology. Bleeding controlled. Diabetes management optimized. Follow-up scheduled for biopsy results. Urgent return precautions given.",
            },
          ],
